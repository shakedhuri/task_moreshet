...
בעבודה זו יוצגו היסטוריית השומרונים,  
חילוקי הדעות על מוצאם   
אמונות ומנהגים (הבדלים בין שני העמים)   
ומעמד האישה השומרונית  
כמות האוכלוסייה כיום   
והקשר לטחינת הר ברכה   
בנוסף תמונות הצולמו במוזיאון השומרונים במהלך הסיור ותמונות הנלקחו מהאינטרנט.
...
<p align="center">
 <img src="Images/6.jpeg" width="450" height="350">
</p>
...
<p align="center">
 <img src="Images/3.jpeg" width="450" height="350">
</p>
...
<p align="center">
 <img src="Images/10.jpeg" width="450" height="350">
</p>
...
<p align="center">
 <img src="Images/12.jpeg" width="450" height="350">
</p>

<p align="center">
 <img src="Images/14.jpeg" width="450" height="350">
</p>

<p align="center">
 <img src="Images/17.jpeg" width="450" height="350">
</p>

<p align="center">
 <img src="Images/20.jpeg" width="450" height="350">
</p>

<p align="center">
 <img src="Images/22.jpeg" width="450" height="350">
</p>

<p align="center">
 <img src="Images/24.jpeg" width="450" height="350">
</p>

<p align="center">
 <img src="Images/27.jpeg" width="450" height="350">
</p>
...
אך גם אצלם יש יוצא מן הכלל, לפי הפסוקים-   
"לפני עיוור לא תיתן מכשול"   
ו-"פיקוח נפש דוחה שבת".
...
כדי למנוע זאת הם מקבלים לדתם נשים מכל העולם המעוניינות לחיות את חייהן כשומרוניות   
...
קיימים עבורה חפצים המיועדים בדיוק לימים אלו   
ועל מנת להקל על האישה את ימי נידתה הנשים האחרות עוזרות ומבשלות לה ולמשפחתה ואף עוזרות בניקיון הבית   
...
בהסתמך על הכתוב בספר ויקר.   
כאשר האישה יולדת בן עליה לשמור 40 ימי טומאה - 7 ימי נידה ועוד 33 ימי טומאה בדרגה מופחתת יותר,  
...
השומרונים כיום מונים כ-840 איש.   

השומרונים מוכרים גם בזכות הטחינה המפורסמת "הר ברכה" שהינם מייצרים במפעל הממוקם ביישוב השומרוני "קריית לוזה",  
בראש הר גריזים ובקרבת היישוב "הר ברכה".  
המפעל שייך לחברת "טחינת הר ברכה".    

לפי המקור מרבית מהסחורה המיוצרת נמכרת בארץ וחלק קטן ממנה מיוצא ונמכר בארצות הברית, אוסטרליה ואירופה.


במהלך הסיור לקחו אותנו אל המפעל ושם יכולנו לקנות טחינה,   
בנוסף גם צפינו בסרטון קצר המתאר את אופן הכנת הטחינה במפעל,  
ויכולנו גם לראות את הנוף המדהים מראש ההר.  
...
הרחבה:  
 ...
 לא רחוק משם נמצא מצפה יוסף, שם אפשר לראות מהגובה את העיר שכם 
 

<p align="center">
 <img src="Images/מצפה יוסף 2.jpeg" width="450" height="350">
</p>
...
<p align="center">
 <img src="Images/נוף שכם עם חברי הקבוצה.jpeg" width="450" height="350">
</p>
...
החלטתי לבנות את עבודה זו באופן טיפה שונה ממה שהתבקשנו.  
רציתי ליצור מין דיאלוג אישי שבו אני שואלת את השאלות העולות לי לראש ושהכי עניינו אותי לחקור תוך כדי כתיבת העבודה    
וישר לאחר מכן הצגת התשובות שהניחו את דעתי.  
המחקר ואסיפת הידע לקחו המון זמן, נושא השומרונים הינו רחב עד כדי תחושת בלבול ואיבוד בין מקורות המידע,     
אך עדיין רציתי לשמור על מבנה הדיאלוג האישי גם כאשר הרגשתי חוסר הבנה מוחלט.    
הנושאים שהכי משכו אותי אלה הם:    
סיבת הפילוג, השבת ומעמד האישה    
באופן הגיוני רציתי לדעת מהי ההיסטוריה, מהו מקור השומרונים, השורש שממנו צמחה דת זו.  
השבת עניינה אותי מכיוון שהפליא אותי לגלות על האמונות השונות אך דומות לשלנו, על שגרת חיים ומסורת שנותרה כמעט ללא שינוי,     
דומה לכך מעמד האישה.  
